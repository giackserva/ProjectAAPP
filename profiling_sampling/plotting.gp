...
f5 = sprintf("data/%s/n_%s/p_0.90/ml_%s_ns_10000_%s_vs2.csv", ARG4, ARG2, ARG3, ARG1)
plot f1 with points title "p=0.1" lt rgb "red", \
    ...
    f4 with points title "p=0.7" lt rgb "orange", \
    f5 with points title "p=0.9" lt rgb "purple"
